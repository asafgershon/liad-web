          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-2 md:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button size="lg" className="bg-[#1e3a5f] hover:bg-[#2d5a8c] text-white text-base">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2 space-y-6">
              ...
              <div className="space-y-4">
                {[
                  "ביטול טיסה ללא הודעה מספקת",
                  "עיכוב טיסה העולה על 3 שעות",
              ...
              <Button size="lg" className="bg-[#d4a574] hover:bg-[#a67c52] text-[#1e3a5f] font-semibold mt-6">
